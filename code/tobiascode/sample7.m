...
coll.FrameFrequency  =300 ;        %Frequency to collect data frames at.          
coll.MarkerFrequency =1000;       %Marker frequency for marker maximum on-time. 
...
optotrak('DataBufferInitializeFile',{'OPTOTRAK'},'R#001.S07');
